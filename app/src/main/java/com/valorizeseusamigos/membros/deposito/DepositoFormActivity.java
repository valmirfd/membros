...
import com.valorizeseusamigos.membros.databinding.ActivityDepositoFormBinding;
import com.valorizeseusamigos.membros.helper.FirebaseHelper;
import com.valorizeseusamigos.membros.model.Deposito;
import com.valorizeseusamigos.membros.model.Extrato;
...
public class DepositoFormActivity extends AppCompatActivity {
    ...
    private ActivityDepositoFormBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDepositoFormBinding.inflate(getLayoutInflater());
    ...
    public void validaDeposito(){
        double valorDeposito = (double) binding.edtValor.getRawValue() / 100;
    ...
    private void configClicks(){
        ...
        binding.btnConfirmar.setOnClickListener(v -> validaDeposito());
    }

    private void configToolbar(){
        binding.include.textTitulo.setText("Depositar");
